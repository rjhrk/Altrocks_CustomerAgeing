...
@EndUserText.label: 'VEND AGEING DISTINCT'
...
define view entity ZI_VEND_AGEING_DISTINCT_N with parameters
    P_Date : datum
  //  as select distinct from I_OperationalAcctgDocItem as _Opr
  as select distinct from ZI_VEND_AGE_FIN_N  (    P_Date: $parameters.P_Date )  as _Opr
    ...
    left outer join       I_JournalEntryItem                                    as _JouItem      on  _Opr.AccountingDocument     = _JouItem.AccountingDocument
                                                                                                 ...
                                                                                                 and _JouItem.Supplier           = _Opr.Supplier
...

{
  ...
  key   _Opr.AccountingDocumentItem,
        ...
        _opr.DocumentReferenceID  as Invoice_Reference,
//        _Opr.AssignmentReference  as Invoice_Reference, // added on 19.8.2026
        _Opr.DocumentDate as Invoice_Date,  // added on 19.8.26
        
        
//        case                             //comment ny lp on 19.08.26
